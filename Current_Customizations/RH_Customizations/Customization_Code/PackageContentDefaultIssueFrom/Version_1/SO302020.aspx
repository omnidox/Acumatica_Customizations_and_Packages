    ...
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%">
        <Items>
            <px:PXTabItem Text="Pick" VisibleExp="DataControls[&quot;chkShowPickWS&quot;].Value == true" BindingContext="formHeader">
                <Template>
                    <px:PXGrid ID="gridPickedWS" runat="server" DataSourceID="ds" SyncPosition="true" Width="100%" SkinID="Inquire" OnRowDataBound="PickWSGrid_RowDataBound">
                        <Levels>
                            <px:PXGridLevel DataMember="PickListOfPicker">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="ForceCompleted" Type="CheckBox"/>
                        ...
                        <ActionBar>
                            <CustomItems>
                                <px:PXToolBarButton CommandName="ReopenLineQty" CommandSourceID="ds" DependOnGrid="gridPickedWS" StateColumn="ForceCompleted"/>
                            </CustomItems>
                        </ActionBar>
                    </px:PXGrid>
                </Template>
            ...
            <px:PXTabItem Text="Pack" VisibleExp="DataControls[&quot;chkShowPack&quot;].Value == true" BindingContext="formHeader">
                <Template>
                    <px:PXSplitContainer runat="server" ID="sp1" CollapseDirection="Panel2" Orientation="Horizontal" Panel2MinSize="50" Panel1MinSize="250" SkinID="Horizontal">
                        ...
                        <Template1>
                            <px:PXGrid ID="gridPacked" runat="server" DataSourceID="ds" SyncPosition="true" Width="100%" SkinID="Inquire" Height="200px"  OnRowDataBound="PackGrid_RowDataBound">
                                <Levels>
                                    <px:PXGridLevel DataMember="PickedForPack">
                                        <Columns>
                                            ...
                                            <px:PXGridColumn DataField="UOM" />
                                            <px:PXGridColumn DataField="SOShipLine__IsFree" Type="CheckBox" />
                                            <px:PXGridColumn DataField="RelatedPickListSplitForceCompleted" Type="CheckBox" />
                                        </Columns>
                                        <RowTemplate>
                                ...
                                <ActionBar>
                                    <CustomItems>
                                        <px:PXToolBarButton CommandName="ReopenLineQty" CommandSourceID="ds" DependOnGrid="gridPacked" StateColumn="RelatedPickListSplitForceCompleted"/>
                                    </CustomItems>
                                </ActionBar>
                            </px:PXGrid>
                        </Template1>
                                ...
                                <Template>
                                    ...
                                    <px:PXFormView ID="formBoxInfo" runat="server" DataSourceID="ds" DataMember="ShownPackage" RenderStyle="Simple">
                                        <Template>
                                            ...
                                            <px:PXTextEdit ID="edDimensions" runat="server" DataField="PackageDimensionsCombined"/>
                                        </Template>
                                    </px:PXFormView>
                                </Template>
                            </px:PXFormView>
