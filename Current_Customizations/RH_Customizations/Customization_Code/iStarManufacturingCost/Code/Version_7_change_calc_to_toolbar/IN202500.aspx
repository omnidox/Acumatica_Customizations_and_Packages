...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
    <px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%" TypeName="PX.Objects.IN.InventoryItemMaint" PrimaryView="Item">
        <CallbackCommands>
            <px:PXDSCallbackCommand Name="AddWarehouseDetail" Visible="false" CommitChanges="true" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="UpdateReplenishment" Visible="false" CommitChanges="true" DependOnGrid="repGrid" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="GenerateSubitems" Visible="false" CommitChanges="true" DependOnGrid="repGrid" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="ViewGroupDetails" Visible="False" DependOnGrid="grid3" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="syncSalesforce" Visible="false" ></px:PXDSCallbackCommand>
      <px:PXDSCallbackCommand Name="ViewRelatedItem" Visible="false" DependOnGrid="relatedItemsGrid" CommitChanges="true" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="ViewVendorEmployee" Visible="false" DependOnGrid="PXGridVendorItems" CommitChanges="true" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="ViewVendorLocation" Visible="false" DependOnGrid="PXGridVendorItems" CommitChanges="true" ></px:PXDSCallbackCommand>
  <px:PXDSCallbackCommand Name="CalculateVendorQuote" Visible="False" DependOnGrid="PXGridVendorItems" CommitChanges="True" />
            <px:PXDSCallbackCommand Name="ViewBAccount" Visible="false" DependOnGrid="crossgrid" CommitChanges="true" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="ViewBOM" Visible="false" CommitChanges="true" ></px:PXDSCallbackCommand>
            <px:PXDSCallbackCommand Name="ViewPlanningBOM" Visible="false" CommitChanges="true" ></px:PXDSCallbackCommand></CallbackCommands>
        <DataTrees></DataTrees>
    </px:PXDataSource>
</asp:Content>
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
  ...
  <px:PXSmartPanel runat="server" ID="pnlCostCalculation" Height="260px" Width="620px" LoadOnDemand="True" AutoReload="True" CaptionVisible="True" Caption="Calculate Vendor Quote" Key="CostCalculation" AcceptButtonID="btnCostCalculationOK" CancelButtonID="btnCostCalculationCancel">
    <px:PXFormView runat="server" ID="frmCostCalculation" SkinID="Transparent" CaptionVisible="False" Width="100%" DataSourceID="ds" DataMember="CostCalculation">
      <Template>
        <px:PXLayoutRule runat="server" ID="lrCostCalculation" StartColumn="True" LabelsWidth="M" ControlSize="M" />
        <px:PXSelector runat="server" DataField="VendorRecordID" AutoRefresh="True" CommitChanges="True" ID="edCostCalculationVendorRecordID" />
        <px:PXSelector runat="server" ID="edCostCalculationVendorID" DataField="VendorID" AutoRefresh="" CommitChanges="" Enabled="False" AllowEdit="False" />
        <px:PXTextEdit runat="server" DataField="VendorName" Enabled="False" ID="edCostCalculationVendorName" />
        <px:PXNumberEdit runat="server" ID="edCostCalculationVendorQuoteCost" DisplayFormat="##0.0000" CommitChanges="True" DataField="VendorQuoteCost" />
        <px:PXNumberEdit runat="server" ID="edCostCalculationPreciousMetalCost" DisplayFormat="##0.000000" Enabled="False" DataField="PreciousMetalCost" />
        <px:PXNumberEdit runat="server" ID="edCostCalculationFabricationPiece" DisplayFormat="##0.0000" Enabled="False" DataField="FabricationPiece" /></Template></px:PXFormView>
    <px:PXPanel runat="server" ID="pnlCostCalculationButtons" SkinID="Buttons">
      ...
      <px:PXButton runat="server" ID="btnCostCalculationCancel" Text="Cancel" DialogResult="Cancel" /></px:PXPanel></px:PXSmartPanel>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    <px:PXTab ID="tab" runat="server" Width="100%" Height="606px" DataSourceID="ds" DataMember="ItemSettings" FilesIndicator="False" NoteIndicator="False">
        ...
        <Items>
          ...
          <px:PXSelector ID="edTemplateItemID" runat="server" DataField="TemplateItemID" AllowEdit="True" Enabled="false" />
                    ...
                    <px:PXDropDown runat="server" ID="PlanningMethodForm" DataField="PlanningMethod" CommitChanges="True" />
                    ...
                    <px:PXFormView ID="CurySettingsFormDefaultSite" runat="server" SkinID="Inside" RenderStyle="Fieldset" DataSourceID="ds" DataMember="ItemCurySettings" Caption="Warehouse Defaults">
                        <Template>
                            ...
                            <px:PXSegmentMask CommitChanges="True" ID="edDfltPutawayLocationID" runat="server" DataField="DfltPutawayLocationID" AutoRefresh="True" AllowEdit="True" />
                        </Template>
                    </px:PXFormView>
                    ...
                    <px:PXSelector ID="edDefaultCostCodeID" runat="server" DataField="DefaultCostCodeID" AutoRefresh="True" CommitChanges="True" />
                    ...
                    <px:PXFormView ID="curySettingsForm2" runat="server" SkinID="Inside" RenderStyle="simple" DataSourceID="ds" DataMember="ItemCurySettings" CaptionVisible="false">
                        <Template>
                            ...
                            <px:PXTextEdit ID="edPendingStdCostLabel" runat="server"
                                           ...
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edPendingStdCost" runat="server" DataField="PendingStdCost" SuppressLabel="true" CommitChanges="true"/>
                            ...
                            <px:PXTextEdit ID="edLastStdCostLabel" runat="server"
                                           ...
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edLastStdCost" runat="server" DataField="ItemCurySettings.LastStdCost" SuppressLabel="true" />
                    ...
                    <px:PXFormView ID="formCostStats" runat="server" Width="100%" DataMember="itemcosts" DataSourceID="ds" SkinID="Transparent">
                        <Template>
                            ...
                            <px:PXTextEdit ID="edAvgCostLabel" runat="server"
                                           ...
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edAvgCost" runat="server" DataField="AvgCost" Enabled="False" SuppressLabel="true" />
                            ...
                            <px:PXTextEdit ID="edMinCostLabel" runat="server"
                                           ...
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edMinCost" runat="server" DataField="MinCost" Enabled="False" SuppressLabel="true" />
                            ...
                            <px:PXTextEdit ID="edMaxCostLabel" runat="server"
                                           ...
                                           Enabled="false"
                                           IsClientControl="false" />
                            <px:PXNumberEdit ID="edMaxCost" runat="server" DataField="MaxCost" Enabled="False" SuppressLabel="true" />
      ...
      <px:PXTabItem Text="Manufacturing" RepaintOnDemand="False">
        <Template>
                    <px:PXFormView runat="server"  RenderStyle="Simple" ID="manufacturingSettingsForm" DataMember="manufacturingSettings">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="M" ControlSize="XM" GroupCaption="General" />
                            ...
                            <px:PXDropDown runat="server" DataField="AMDefaultMarkFor" ID="edAMDefaultMarkFor" />
                            <px:PXCheckBox runat="server" ID="chkAMMakeToOrderItem" DataField="AMMakeToOrderItem" />
                            ...
                            <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Production Order Defaults" />
                            <px:PXDropDown runat="server" Enabled="False" CommitChanges="True" Size="SM" DataField="ReplenishmentSource" ID="edAMReplenishmentSource" />
                            <px:PXNumberEdit runat="server" Enabled="False" ID="edAMMinOrdQty" DataField="AMMinOrdQty" />
                            <px:PXNumberEdit runat="server" Enabled="False" ID="edAMMaxOrdQty" DataField="AMMaxOrdQty" />
                            <px:PXNumberEdit runat="server" Enabled="False" ID="edAMLotSize" DataField="AMLotSize" />
                            <px:PXNumberEdit runat="server" Enabled="False" ID="edAMMFGLeadTime" DataField="AMMFGLeadTime" />
                            <px:PXLayoutRule runat="server" StartColumn="True"/>
                            ...
                            <px:PXCheckBox runat="server" DataField="AMCheckSchdMatlAvailability" ID="edAMCheckSchdMatlAvailability" />
                            <px:PXLayoutRule runat="server" ID="edGeneralLayoutRule8" LabelsWidth="S" ControlSize="XM" />        
                        </Template>
                    </px:PXFormView>
          <px:PXLayoutRule runat="server" ID="edGeneralLayoutRule8" LabelsWidth="S" ControlSize="XM" />
            ...
            <Levels>
              <px:PXGridLevel DataMember="AMSubItemDefaults" DataKeyNames="SiteID,InventoryID,SubItemID">
                <RowTemplate>
                  ...
                  <px:PXSegmentMask runat="server" DataField="SiteID" ID="edSubItemAMSiteID" />
                  <px:PXCheckBox runat="server" DataField="IsItemDefault" ID="edSubItemAMIsItemDefault" />
                  <px:PXSelector runat="server" DataField="BOMID" ID="edSubItemAMBOMID" AutoRefresh="True" />
                  <px:PXSelector runat="server" DataField="PlanningBOMID" ID="edSubItemAMPlanningBOMID" AutoRefresh="True" />
                                </RowTemplate>
                <Columns>
                  <px:PXGridColumn DataField="SiteID" />
                  <px:PXGridColumn DataField="SubItemID" />
                  <px:PXGridColumn DataField="IsItemDefault" Type="CheckBox" TextAlign="Center" CommitChanges="True" Width="40px" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="itemsiterecords" DataKeyNames="InventoryID,SiteID">
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask SuppressLabel="True" ID="edDfltPutawayLocationID" runat="server" DataField="DfltPutawayLocationID" AutoRefresh="True" />
                                </RowTemplate>
                                <Columns>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="VendorItems" DataKeyNames="RecordID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="PrepaymentPct" TextAlign="Right" AllowNull="True" ></px:PXGridColumn>
                                </Columns>
                            </px:PXGridLevel>
                        </Levels>
  ...
  <ActionBar>
    <CustomItems>
      <px:PXToolBarButton Text="Calc" CommandSourceID="ds" CommandName="CalculateVendorQuote" Key="CalculateVendorQuoteGrid" Tooltip="Calc" AllowHide="False" DependOnGrid="PXGridVendorItems" SyncText="False" /></CustomItems></ActionBar>
  <ActionBar CustomItemsGroup="2" /></px:PXGrid>
                </Template>
            </px:PXTabItem>
                    ...
                    <px:PXGrid ID="PXGridLotSerialAttributes" runat="server" Caption="Lot/Serial Attributes" CaptionVisible="true" DataSourceID="ds" Height="150px" Width="620px" SkinID="Details" ActionsPosition="Top" AutoAdjustColumns="true">
                        <Levels>
                            <px:PXGridLevel DataMember="LotSerialAttributes">
                                <RowTemplate>
                                    <px:PXLayoutRule runat="server" ControlSize="XM" LabelsWidth="M" StartColumn="True" />
                                    <px:PXSelector ID="edLotSerialAttributeID" runat="server" DataField="AttributeID" AutoRefresh="true" FilterByAllFields="True" />
                                    <px:PXNumberEdit ID="edLotSerialAttrSortOrder" runat="server" DataField="SortOrder" />
                                </RowTemplate>
                                <Columns>
                                    <px:PXGridColumn DataField="IsActive" AllowNull="False" TextAlign="Center" Type="CheckBox" />
                                    <px:PXGridColumn DataField="AttributeID" DisplayFormat="&gt;aaaaaaaaaa" Width="81px" AutoCallBack="True" />
          ...
          <px:PXFormView runat="server" ID="formPacejet" DataMember="CarrierData" SkinID="Inside" RenderStyle="Simple">
            <Template>
              <px:PXLayoutRule runat="server" StartGroup="True" GroupCaption="Pacejet Packaging" LabelsWidth="M" />
              <px:PXTextEdit runat="server" ID="edPacejetTariffCode" DataField="PacejetTariffCode" />
              <px:PXTextEdit runat="server" ID="edPacejetCommodityCode" DataField="PacejetCommodityCode" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="itemxrefrecords" DataKeyNames="InventoryID,SubItemID,AlternateType,BAccountID,AlternateID">
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="BAccountID" Width="135px" CommitChanges="true" LinkCommand="ViewBAccount"/>
  ...
  <Template>
    <px:PXFormView ID="formDR" runat="server" Width="100%" DataMember="ItemSettings" DataSourceID="ds" Caption="Rules" CaptionVisible="False" SkinID="Transparent">
      <Template>
        ...
        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="M" />
        <px:PXDropDown ID="edPreferredItemClasses" runat="server" DataField="PreferredItemClasses" AllowEdit="True"/>
        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="XM" ControlSize="M" />
        <px:PXDropDown ID="edPriceOfSuggestedItems" runat="server" DataField="PriceOfSuggestedItems" AllowEdit="True"/>
        </px:PXPanel>
      </Template>
    </px:PXFormView>                 
      ...
      <Levels>
        <px:PXGridLevel DataMember="RelatedItems" DataKeyNames="InventoryID,Relation" ImportDataMember="RelatedItems">
          <Columns>
            ...
            <px:PXGridColumn DataField="AcceptedMLSuggestion" TextAlign="Center" Type="CheckBox" />
          ...
          <RowTemplate>
            ...
            <px:PXNumberEdit ID="edMLScorePercent" runat="server" DataField="MLScorePercent" Enabled="False"/>
            <px:PXCheckBox ID="edAcceptedMLSuggestion" runat="server" DataField="AcceptedMLSuggestion" CommitChanges="true" />
            ...
            <px:PXTabItem Text="Inventory Planning" RepaintOnDemand="False" LoadOnDemand="True">
                <Template>      
                    <px:PXFormView runat="server" ID="inventoryPlanningSettingsForm" DataMember="inventoryPlanningSettings" SkinID="Transparent" RenderStyle="Simple">
                        <Template>
                            <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" StartColumn="True" GroupCaption="Inventory Planning Settings" />
                            <px:PXDropDown runat="server" ID="edReplenishmentSource" CommitChanges="True" DataField="ReplenishmentSource" />
                            <px:PXFormView ID="CurySettingsFormPlanning" runat="server" RenderStyle="Simple"  DataSourceID="ds" DataMember="ItemCurySettings" CaptionVisible="false">
                                <Template>  
                                    <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" />
                                    <px:PXSegmentMask CommitChanges="True" ID="edSourceSiteID" runat="server" DataField="AMSourceSiteID" AllowEdit="true" />
                                </Template>
                            </px:PXFormView>
                    ...
                    <px:PXFormView runat="server" RenderStyle="Simple" SkinID="Transparent" ID="frmProjectDefaults" DataMember="ItemSettings" AllowCollapse="True">
                        <Template>
                            <px:PXLayoutRule runat="server" StartGroup="True" LabelsWidth="XM" GroupCaption="Project Defaults" />
                            <px:PXDropDown ID="edDefaultInventorySourceForProjects" runat="server" DataField="DefaultInventorySourceForProjects" CommitChanges="True" />
                        </Template>
                    </px:PXFormView>
                    <px:PXFormView runat="server" RenderStyle="Simple" SkinID="Transparent" ID="frmProductionDefaults" DataMember="productionOrderDefaultSettings">
                        <Template>
                            <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="SM" ControlSize="XM" GroupCaption="Production Order Defaults"/>
                            <px:PXDropDown runat="server" ID="ddReplenishmentSource" CommitChanges="True" DataField="ReplenishmentSource" />
                            <px:PXFormView ID="CurySettingsFormPlanning" runat="server" RenderStyle="Simple"  DataSourceID="ds" DataMember="ItemCurySettings" CaptionVisible="false">
                                <Template>  
                                    <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" />
                                    <px:PXSegmentMask CommitChanges="True" ID="edSourceSiteID" runat="server" DataField="AMSourceSiteID" AllowEdit="true" />
...
<%--                    <px:PXLayoutRule runat="server" LabelsWidth="SM" ControlSize="XM" StartColumn="true"  />--%>
                            ...
                            <Levels>
                                <px:PXGridLevel DataMember="replenishment" DataKeyNames="InventoryID,ReplenishmentClassID">
                                    ...
                                    <Columns>
                                        ...
                                        <px:PXGridColumn DataField="ReplenishmentSourceSiteID" Width="140px" CommitChanges="true" />
            ...
            <px:PXTabItem Text="Deferral">
              ...
              <px:PXLayoutRule runat="server" />
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Components" DataKeyNames="InventoryID,ComponentID">
                                <RowTemplate>
                                    ...
                                    <px:PXDropDown ID="edPriceOptionASC606" runat="server" DataField="AmtOptionASC606" CommitChanges="true" />
                  ...
                  <px:PXNumberEdit runat="server" ID="edDefaultTerm" DataField="DefaultTerm" CommitChanges="true" />
                                    <px:PXCheckBox ID="chkOverrideDefaultTerm" runat="server" DataField="OverrideDefaultTerm" />
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="OverrideDefaultTerm" TextAlign="Center" Type="CheckBox" CommitChanges="true" />
                                    <px:PXGridColumn DataField="AmtOption" RenderEditorText="True" Width="81px" CommitChanges="true" />
                                    <px:PXGridColumn DataField="AmtOptionASC606" RenderEditorText="True" Width="81px" CommitChanges="true" />
          ...
          <px:PXSegmentMask runat="server" DataField="AMWIPAcctID" AutoRefresh="True" CommitChanges="True" ID="edWIPAcctID" />
          <px:PXSegmentMask runat="server" DataField="AMWIPSubID" AutoRefresh="True" DataKeyNames="Value" CommitChanges="True" ID="edWIPSubID" />
          <px:PXSegmentMask runat="server" DataField="AMWIPVarianceAcctID" CommitChanges="true" ID="edAMWIPVarianceAcctID" />
          <px:PXSegmentMask runat="server" DataField="AMWIPVarianceSubID" AutoRefresh="True" ID="edAMWIPVarianceSubID" />
                </Template>
            </px:PXTabItem>
                ...
                <Columns>
                  ...
                  <px:PXGridColumn DataField="VendorID" Width="120px" />
                                ...
                                <RowTemplate>
                                    ...
                                    <px:PXSegmentMask ID="edEQInventoryID" runat="server" DataField="InventoryID" CommitChanges="True" AutoRefresh="True" AllowEdit="True"/>
      ...
      <px:PXTabItem Text="eCommerce">
        <Template>
          <px:PXLayoutRule runat="server" ID="BCPXLayoutRule1" StartColumn="True" LabelsWidth="SM" ControlSize="XL" />
          ...
          <px:PXDropDown runat="server" ID="edAvailability" DataField="Availability" CommitChanges="True" />
                    <px:PXNumberEdit runat="server" ID="edAvailabilityAdjustment" DataField="AvailabilityAdjustment" AllowNull="True" Size="M" CommitChanges="True" />
          ...
          <px:PXTextEdit runat="server" ID="edMetaDescription" DataField="MetaDescription" TextMode="MultiLine" Height="150" />
