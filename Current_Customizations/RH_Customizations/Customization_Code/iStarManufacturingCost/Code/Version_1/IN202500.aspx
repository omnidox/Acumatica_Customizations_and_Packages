...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
  ...
  <px:PXSmartPanel runat="server" Height="290px" Width="520px" ID="pnlCostCalculation" LoadOnDemand="True" AutoReload="True" CaptionVisible="True" Caption="Calculate Unit Cost" Key="CostCalculation" AcceptButtonID="btnCostCalculationOK" CancelButtonID="btnCostCalculationCancel">
    <px:PXFormView runat="server" SkinID="Transparent" CaptionVisible="False" Width="100%" ID="frmCostCalculation" DataSourceID="ds" DataMember="CostCalculation">
      <Template>
        <px:PXLayoutRule runat="server" StartColumn="True" LabelsWidth="M" ControlSize="M" ID="lrCostCalculation" />
        <px:PXNumberEdit runat="server" DisplayFormat="##0.000000" CommitChanges="True" DataField="UnitCost" ID="edCostCalculationUnitCost" />
        <px:PXNumberEdit runat="server" DisplayFormat="##0.000000" Enabled="False" DataField="MetalWeight" ID="edCostCalculationMetalWeight" />
        <px:PXNumberEdit runat="server" DisplayFormat="##0.000000" Enabled="False" DataField="PreciousMetalCost" ID="edCostCalculationPreciousMetalCost" />
        <px:PXNumberEdit runat="server" DisplayFormat="##0.000000" Enabled="False" DataField="FabricationCost" ID="edCostCalculationFabricationCost" /></Template></px:PXFormView>
    <px:PXPanel runat="server" SkinID="Buttons" ID="pnlCostCalculationButtons">
      <px:PXButton runat="server" Text="OK" DialogResult="OK" ID="btnCostCalculationOK" />
      <px:PXButton runat="server" Text="Cancel" DialogResult="Cancel" ID="btnCostCalculationCancel" /></px:PXPanel></px:PXSmartPanel>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="VendorItems" DataKeyNames="RecordID">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="VendorID" Width="81px" CommitChanges="True" LinkCommand="ViewVendorEmployee"/>
                                    <px:PXGridColumn DataField="Vendor__AcctName" Width="210px" />
                                    <px:PXGridColumn DataField="VendorLocationID" Width="54px" CommitChanges="True" LinkCommand="ViewVendorLocation"/>
