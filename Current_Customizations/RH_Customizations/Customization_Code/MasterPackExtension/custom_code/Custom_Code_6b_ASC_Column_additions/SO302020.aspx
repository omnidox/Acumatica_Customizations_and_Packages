    ...
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%">
        <Items>
            ...
            <px:PXTabItem Text="Pack" VisibleExp="DataControls[&quot;chkShowPack&quot;].Value == true" BindingContext="formHeader">
                <Template>
                    <px:PXSplitContainer runat="server" ID="sp1" CollapseDirection="Panel1" Orientation="Horizontal" Panel2MinSize="700" Panel1MinSize="250" SkinID="Horizontal">
        ...
        <Levels>
          <px:PXGridLevel DataMember="SelectedPackageContentsView">
            <Columns>
              ...
              <px:PXGridColumn DataField="RemainingQty" Width="100" />
              <px:PXGridColumn DataField="SkippedStatus" Width="60" Type="CheckBox" /></Columns></px:PXGridLevel></Levels></px:PXGrid></Template2></px:PXSplitContainer></Template2>
                    </px:PXSplitContainer>
                </Template>
            </px:PXTabItem>
